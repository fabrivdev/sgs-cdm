...
La misma entrada se aplica a Dashboard, Comisiones, Administración, Clientes/Parque, Máquinas/Stock, Operaciones/Importaciones, catálogo de Repuestos, Sugerencias, Compras, Calendario y Planificador. La ampliación posterior incorpora orden y exportaciones a Ventas de Máquinas/Repuestos y más listados; no modifica crear, editar, validar o pagar. Cobertura, excepciones y comprobaciones: `docs/tablas-orden-exportacion.md`.

La centralización inicial no requiere SQL. La ampliación del orden global paginado de Ventas de Repuestos/Sugerencias requiere las dos migraciones manuales del 18/09 documentadas en `docs/tablas-orden-exportacion.md`. Pruebas locales con datos ficticios no acreditan estado ni ejecución en producción.
