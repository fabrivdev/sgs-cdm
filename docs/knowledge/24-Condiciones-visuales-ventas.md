...
Unificación por pasos fuera del Dashboard ejecutivo, autorizada el 18/09: aplicar el mismo patrón a Stock/Ficha/Compras de Repuestos, Parque/Importaciones y listas/historiales de Servicios. No convertir calendarios, matrices ni previsualizaciones de carga en listas genéricas. No tocar el Dashboard en esta revisión. Primer paso: Catálogo y Stock muestra doce campos separados y cantidades centradas con `PartsStockTable`; en anchos menores a 1024 px conserva cuatro columnas legibles y los secundarios en ficha/Excel. Sin datos apilados ni anchos mínimos; marca con color compartido, textos completos al pasar el cursor y stock sin sufijos. Mantiene consultas y nueve claves de orden global existentes; Marca/Fabricante/Familia requieren ampliar SQL en un paso posterior, nunca simular orden sobre una página. Verificación local: 18 pruebas, tipos/lint/compilación y navegador con datos ficticios en cinco anchos. No cambia cálculos ni valida producción; no requiere SQL nuevo por este primer paso.
