...
export function demoOrder(extra: Partial<OrdenServicioImportada> = {}): OrdenServicioImportada {
  return { id: "O1", os_numero: "01-00000001", trabajo_id: "W1", cliente_nombre: "CLIENTE DEMOSTRACIÓN", fecha_abierta_os: "2026-08-10", fecha_cierre_os: "2026-09-10", fecha_emision_factura: null, factura: null,
...
export function operationsFixture(): OperationsData {
  return { ...emptyOperationsData, metaHorasMensual: 120,
    ...
    ], ordenesServicio: [demoOrder(), demoOrder({ id: "O2", os_numero: "01-00000002", fecha_abierta_os: "2026-09-12", fecha_cierre_os: null, situacion_os: "Abierta", responsable: "TECNICO DOS", servicios_cantidad: 0 })],
  };
}
