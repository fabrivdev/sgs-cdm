...
export function ServiciosClientes({ desde, hasta, sucursal, buscar, tipoTiempo }: { desde: string; hasta: string; sucursal: string; buscar: string; tipoTiempo: string }) {
  ...
  return <div className="mt-3 overflow-x-auto rounded-md border"><div className="min-w-[1080px]">
    <div className="grid grid-cols-[minmax(230px,1fr)_70px_70px_repeat(4,110px)_130px_105px] bg-muted/60 px-3 py-2 text-[11px] font-medium text-muted-foreground"><div>Cliente</div><div className="text-right">OS</div><div className="text-right">Fact.</div><div className="text-right">MO</div><div className="text-right">Km</div><div className="text-right">Repuestos</div><div className="text-right">Terceros</div><div className="text-right">Facturación</div><div className="text-right" title={!comparable ? "Período no comparable: el año anterior cae del lado histórico del corte (01/07/2026)." : undefined}>vs. año ant.{!comparable && " *"}</div></div>
