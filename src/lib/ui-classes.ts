...
// Jerarquía de texto
export const pageTitle = "text-[20px] font-semibold leading-7 tracking-[-0.02em]";
export const pageDescription = "text-[11px] leading-4 text-muted-foreground";
...
export const cardLabel = "text-[11px] leading-4 uppercase tracking-[0.04em] text-muted-foreground font-medium";
...
export const controlHeight = "h-[34px]";
export const controlText = "text-[13px]";
